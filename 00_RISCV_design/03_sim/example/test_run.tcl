...
#    file copy -force "../../../src/matlab/sin64_data.txt" "./"
    ...
    vlog -timescale 1ns/1ns -vlog01compat -work rtl_lib "$rtl_path/*.v"
    vlog -timescale 1ns/1ns -vlog01compat -work rtl_lib "../riscv_imem.v"
    vlog -timescale 1ns/1ns -vlog01compat -work tb_lib  "$tb_path/testbench.v"
